...
var SERIAL_NUMBER = 'IG30417300003680';

var button = document.querySelector('.js-button');
var wrapper = document.querySelector('.js-content');
var send = document.querySelector('.js-send-button');
...
send.addEventListener('click', function () {
    var text = document.querySelector('.js-text-data').value;
    console.log(text);
    database.ref('chat').push({ 'post': text });
});

database.ref('chat').on('value', function (snapshot) {
    var text = (0, _stringify2.default)((0, _values2.default)(snapshot.val()));
    document.querySelector('.js-textarea').innerHTML = text;
});

},{"babel-runtime/core-js/json/stringify":1,"babel-runtime/core-js/object/values":2,"lodash":38}]},{},[39]);
